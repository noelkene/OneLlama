...
@st.cache_resource
def load_models():
    text_model_pro = GenerativeModel("gemini-1.0-pro-001")
    multimodal_model_pro = GenerativeModel("gemini-1.0-pro-vision-001")
...
with tab3:
    ...
    Focus on the following areas based on the input amoutnof time the person wants to spend:
